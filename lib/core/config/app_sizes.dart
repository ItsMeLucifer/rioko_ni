class AppSizes {
  ...
  static const double paddingQuadruple = padding * 4;
  static const double paddingQuintuple = padding * 5;
  ...
  static const double radiusDouble = radius * 2;
  static const double radiusQuadruple = radiusDouble * 2;
}
